              ...
              <div class="col-md-3">
               ...
               <div class="card mb-3">
                   ...
                   <div class="card-body">
                     ...
                     <p><paper-button   on-click="showDetails" >View Details</paper-button></p>
                </div>
               </div>
             </div>
           </template>
...
`;
  ...
  static get properties() {
    return {
      // It will takes product id from my app page which is used to select product 
      productId: {
        type: Number,
        notify: true,
        observer: "_checkId"
      },
      // taking  products json array 
      products: {
        type: Array,
        notify: true
      },
  ...
  _checkId(e) { //  observer call back funtion 
  }
}
